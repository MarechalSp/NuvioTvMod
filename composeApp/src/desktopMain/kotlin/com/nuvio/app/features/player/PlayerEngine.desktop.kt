...
actual fun PlatformPlayerSurface(
    ...
    if ((DesktopHostOs.current == DesktopHostOs.MACOS ||
        ...
        NativePlayerBridge.isAvailable
    ) {
        NativePlayerSurface(
            sourceUrl = sourceUrl,
...
private fun DesktopStubPlayerSurface(
    ...
    Box(
        ...
        Text(
            text = "Player nativo indisponível nesta compilação local de desenvolvimento.\nUtilize o botão de player externo / VLC ou navegador.",
