...
import nuvio.composeapp.generated.resources.compose_nav_channels
...
import nuvio.composeapp.generated.resources.sidebar_tv_channels
...
internal fun MainTabsDestination(
    ...
    BoxWithConstraints(modifier = Modifier.fillMaxSize()) {
        ...
        val tvChannelsState by remember { TvChannelsRepository.uiState }.collectAsStateWithLifecycle()
        val isTvFullscreen = selectedTab == AppScreenTab.Channels && tvChannelsState.isFullscreen

        val useDesktopSidebar = !isTvFullscreen &&
            isDesktop &&
            isTabletLayout &&
            !useNativeBottomTabs &&
            desktopNavigationLayout == DesktopNavigationLayout.Sidebar
        val useDesktopTopBar = !isTvFullscreen && isDesktop && !useNativeBottomTabs && !useDesktopSidebar
        val useFloatingTopBar = !isTvFullscreen && !isDesktop && isTabletLayout && !useNativeBottomTabs
        ...
        val contentStartPadding = if (useDesktopSidebar && !isTvFullscreen) {
        ...
        val floatingNavigationItems = listOf(
            ...
            FloatingNavigationItem(
                selected = selectedTab == AppScreenTab.Channels,
                onClick = { onTabSelected(AppScreenTab.Channels) },
                drawable = Res.drawable.sidebar_tv_channels,
                label = stringResource(Res.string.compose_nav_channels),
            ),
            FloatingNavigationItem(
        ...
        Scaffold(
            ...
            bottomBar = {
                if (!isTvFullscreen && !isDesktop && !isTabletLayout && !useNativeBottomTabs && navBarStyleSetting == NavBarStyle.CLASSIC) {
                    NuvioClassicNavigationBar {
                        ...
                        NavItem(
                            selected = selectedTab == AppScreenTab.Channels,
                            onClick = { onTabSelected(AppScreenTab.Channels) },
                            icon = Res.drawable.sidebar_tv_channels,
                            contentDescription = stringResource(Res.string.compose_nav_channels),
                        )
                        NavItem(
                            selected = selectedTab == AppScreenTab.Library,
                            onClick = { onTabSelected(AppScreenTab.Library) },
            ...
            Box(modifier = Modifier.fillMaxSize()) {
                ...
                CompositionLocalProvider(
                    ...
                    AppTabHost(
                        ...
                        modifier = Modifier
                            ...
                            .padding(if (isTvFullscreen) PaddingValues(0.dp) else innerPadding)
                ...
                if (!isTvFullscreen && isTabletLayout && !useNativeBottomTabs && !isDesktop) {
