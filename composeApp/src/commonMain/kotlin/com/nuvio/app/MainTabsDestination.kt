...
internal fun MainTabsDestination(
    ...
    BoxWithConstraints(modifier = Modifier.fillMaxSize()) {
        ...
        val useFloatingTopBar = !isTvFullscreen && isTabletLayout && !useNativeBottomTabs && !useDesktopSidebar
        ...
        Scaffold(
            ...
            bottomBar = {
                if (!isTvFullscreen && !isTabletLayout && !useNativeBottomTabs && navBarStyleSetting == NavBarStyle.CLASSIC) {
