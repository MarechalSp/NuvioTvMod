...
import com.nuvio.app.features.tvchannels.TvChannelsScreen
...
internal data class AppTabRequests(
    ...
    val channelsScrollToTopRequests: Flow<Unit>,
...
internal data class AppTabActions(
    ...
    val onWatchTvChannel: ((TvChannelItem, StreamItem?) -> Unit)? = null,
            ...
            Box {
                ...
                Row(
                    ...
                    TabletTopPillItem(
                        ...
                        icon = {
                            Icon(
                                painter = painterResource(Res.drawable.sidebar_tv_channels),
                                contentDescription = stringResource(Res.string.compose_nav_channels),
                                modifier = Modifier.size(navIconSize),
                                tint = if (selectedTab == AppScreenTab.Channels) {
                                    tokens.colors.textPrimary
                                } else {
                                    Color.White.copy(alpha = 0.70f)
                                },
        ...
        BoxWithConstraints(
            ...
            Column(
                ...
                DesktopSidebarItem(
                    ...
                    selected = selectedTab == AppScreenTab.Channels,
                    expanded = sidebarExpanded,
                    onClick = { selectTab(AppScreenTab.Channels) },
                ) { color ->
                    Icon(
                        painter = painterResource(Res.drawable.sidebar_tv_channels),
                        contentDescription = stringResource(Res.string.compose_nav_channels),
